...
The primary classes of the AustESE Ontology are: Artefact, Version, Work, Agent and Event. These are defined in Fig. 1. This image should not be seen as a hierarchy of terms since the modularity of the AustESE system enables a collection of digital files to be assembled in any order.
